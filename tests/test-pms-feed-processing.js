...
async function testPmsFeedProcessing() {
    ...
    try {
        ...
        console.log('🔄 Step 2: Testing translation endpoint...');
        ...
        console.log('📤 Translated data:', translationResult.translatedData);
        console.log('');

        // Step 3: Test with different PMS feed formats
        console.log('🔄 Step 3: Testing with different feed formats...');
...
<booking>
    ...
    <totalAmount>599.99</totalAmount>
        ...
        if (xmlResponse.ok) {
            ...
            console.log('📤 XML translated data:', xmlResult.translatedData);
        } else {
        ...
        // Test with invalid PMS code
        const invalidResponse = await fetch('http://localhost:8000/api/pms/invalid-pms-code', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ feedData: 'test data' }),
        });

        if (!invalidResponse.ok) {
            console.log('✅ Error handling working correctly for invalid PMS code');
        }
        console.log('');

        // Step 5: Test the test endpoint
        console.log('🔄 Step 5: Testing the test endpoint...');
        ...
        console.log('✅ JSON feed translation');
        console.log('✅ XML feed translation');
